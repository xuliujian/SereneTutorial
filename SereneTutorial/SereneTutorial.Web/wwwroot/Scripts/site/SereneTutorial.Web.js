...
(function (SereneTutorial) {
    ...
    })(Administration = SereneTutorial.Administration || (SereneTutorial.Administration = {}));
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var Administration;
    (function (Administration) {
...
(function (SereneTutorial) {
    ...
    })(BasicSamples = SereneTutorial.BasicSamples || (SereneTutorial.BasicSamples = {}));
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneTutorial.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = SereneTutorial.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = SereneTutorial.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (SereneTutorial) {
    ...
    })(Common = SereneTutorial.Common || (SereneTutorial.Common = {}));
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var Common;
...
(function (SereneTutorial) {
    ...
    })(Membership = SereneTutorial.Membership || (SereneTutorial.Membership = {}));
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var Membership;
...
(function (SereneTutorial) {
    ...
    })(Northwind = SereneTutorial.Northwind || (SereneTutorial.Northwind = {}));
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var Northwind;
...
(function (SereneTutorial) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(OrderShippingState, 'SereneTutorial.Northwind.OrderShippingState', 'Northwind.OrderShippingState');
    })(Northwind = SereneTutorial.Northwind || (SereneTutorial.Northwind = {}));
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
...
(function (SereneTutorial) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = SereneTutorial.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = SereneTutorial.LanguageList || (SereneTutorial.LanguageList = {}));
})(SereneTutorial || (SereneTutorial = {}));
...
(function (SereneTutorial) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = SereneTutorial.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = SereneTutorial.ScriptInitialization || (SereneTutorial.ScriptInitialization = {}));
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var Administration;
...
(function (SereneTutorial) {
    ...
    SereneTutorial.BasicProgressDialog = BasicProgressDialog;
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new SereneTutorial.BasicProgressDialog();
...
(function (SereneTutorial) {
    ...
    })(DialogUtils = SereneTutorial.DialogUtils || (SereneTutorial.DialogUtils = {}));
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var Common;
...
(function (SereneTutorial) {
    ...
    SereneTutorial.StaticTextBlock = StaticTextBlock;
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                SereneTutorial.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(SereneTutorial.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(SereneTutorial.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(SereneTutorial.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        SereneTutorial.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: SereneTutorial.Authorization.userDefinition.DisplayName,
...
(function (SereneTutorial) {
    ...
    (function (Northwind) {
        ...
        }(SereneTutorial.Common.GridEditorDialog));
...
(function (SereneTutorial) {
    ...
    (function (Northwind) {
        ...
        }(SereneTutorial.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return SereneTutorial.LanguageList.getValue();
            };
...
(function (SereneTutorial) {
    ...
    })(Authorization = SereneTutorial.Authorization || (SereneTutorial.Authorization = {}));
})(SereneTutorial || (SereneTutorial = {}));
var SereneTutorial;
(function (SereneTutorial) {
    var BasicSamples;
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneTutorial.Northwind.ProductDialog));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneTutorial.Northwind.ProductGrid));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: SereneTutorial.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: SereneTutorial.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new SereneTutorial.Northwind.OrderDialog();
                        ...
                        var chai = SereneTutorial.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = SereneTutorial.Northwind.EmployeeRow.getLookup().items
        ...
        }(SereneTutorial.Northwind.OrderGrid));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneTutorial.Northwind.OrderDialog));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    SereneTutorial.Northwind.CategoryService.Retrieve({
        ...
        }(SereneTutorial.Northwind.CategoryDialog));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneTutorial.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(SereneTutorial.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new SereneTutorial.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                SereneTutorial.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(SereneTutorial.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    SereneTutorial.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(SereneTutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(SereneTutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    SereneTutorial.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return SereneTutorial.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return SereneTutorial.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return SereneTutorial.Northwind.OrderService.baseUrl; };
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneTutorial.Northwind.SupplierDialog));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(SereneTutorial.Northwind.SupplierGrid));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return SereneTutorial.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return SereneTutorial.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return SereneTutorial.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return SereneTutorial.Northwind.OrderService.baseUrl; };
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    SereneTutorial.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(SereneTutorial.Northwind.CustomerDialog));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneTutorial.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = SereneTutorial.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return SereneTutorial.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new SereneTutorial.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(SereneTutorial.Northwind.OrderDetailDialog));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneTutorial.Northwind.OrderDetailsEditor));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return SereneTutorial.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return SereneTutorial.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return SereneTutorial.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return SereneTutorial.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        ...
        }(SereneTutorial.Common.BulkServiceAction));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return SereneTutorial.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return SereneTutorial.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return SereneTutorial.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(SereneTutorial.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new SereneTutorial.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new SereneTutorial.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new SereneTutorial.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (SereneTutorial) {
    ...
    SereneTutorial.SelectableEntityGrid = SelectableEntityGrid;
})(SereneTutorial || (SereneTutorial = {}));
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return SereneTutorial.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return SereneTutorial.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return SereneTutorial.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(SereneTutorial.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = SereneTutorial.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            SereneTutorial.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return SereneTutorial.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return SereneTutorial.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return SereneTutorial.Northwind.ProductService.baseUrl; };
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return SereneTutorial.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return SereneTutorial.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return SereneTutorial.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return SereneTutorial.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (SereneTutorial) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return SereneTutorial.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return SereneTutorial.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return SereneTutorial.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=SereneTutorial.Web.js.map